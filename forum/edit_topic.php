...
if ($permissionAllowed == false) {
    buckys_redirect("/forum/edit_topic.php", MSG_PERMISSION_DENIED, MSG_TYPE_ERROR);
}
...
if(isset($_POST['action']))
{
    if($_POST['action'] == 'edit-topic')
    {
        ...
        if($result === true)
        {
            buckys_redirect("/forum/edit_topic.php?id=" . $topicID, MSG_TOPIC_POSTED_SUCCESSFULLY, MSG_TYPE_SUCCESS);
        }else{
...
$BUCKYS_GLOBALS['title'] = 'Edit Topic - BuckysRoomForum';
