            ...
            <form method="post" id="bannedusersform" action="/banned_users.php" style="padding-top:0px;">
                ...
                <div class="table">
                    ...
                    <div class="tr <?php echo $i == count($users) - 1 ? 'noborder' : ''?>">
                        <div class="td td-chk"><input type="checkbox" id="chk<?php echo $row['bannedID']?>" name="bannedID[]" value="<?php echo $row['bannedID']?>" /></div>
                        <div class="td td-user">
                            <a href="/profile.php?user=<?php echo $row['bannedUserID']?>">
                        ...
                        <div class="td td-reporter">
                            <a href="/profile.php?user=<?php echo $row['moderatorID']?>">
                                <img src="<?php echo BuckysUser::getProfileIcon(array('thumbnail'=>$row['moderatorThumb'], 'userID'=>$row['moderatorID']))?>" />
                                <?php 
                ...
                <div class="btn-row">
                    <input type="button" class="redButton" value="Delete Users" id="delete-users" />
                    <input type="button" class="redButton" value="Unban Users" id="unban-users" />
                </div>
