        ...
        <section id="right_side_padding" class="user-info-section">
            ...
            <div id="send-credits">
                ...
                <form name="sendcreditsform" id="sendcreditsform" action="/credits.php" method="post">
                    ...
                    <div class="row">
                        <label>Amount: </label>
                        <input type="text" class="input" name="amount" id="amount" />
                        <div class="clear"></div>
                    </div>
                    <div class="row">
                        <label>&nbsp;</label>
                        <input type="submit" id="send-credits-btn" value="Send Credits" class="redButton" />
                        <div class="clear"></div>
                    </div>                       
            ...
            <div id="purchase-credits">
                ...
                <br/>
                    <div class="row">
                        <input type="radio" name="credits" id="credits10" value="3.5" />
                        <label for="credits10">10 Credits for $3.50 <span style="color:#999999;font-size:11px;">(35&cent; per credit)</span></label>
                    </div>
                    <div class="row">
                        <input type="radio" name="credits" id="credits50" value="15" />                        
                        <label for="credits50">50 Credits for $15.00 <span style="color:#999999;font-size:11px;">(30&cent; per credit)</span></label>
                    </div>
                    <div class="row">
                        <input type="radio" name="credits" id="credits100" value="25" />                        
                        <label for="credits100">100 Credits for $25.00 <span style="color:#999999;font-size:11px;">(25&cent; per credit)</span></label>
                    </div>
                    <div class="row">
                ...
                <form id="paypalForm" action="<?php echo $paypalSetting['url'];?>" method="post">
                    ...
                    <input type="hidden" name="business" value="<?php echo $paypalSetting['merchant_email'];?>">
                    <input type="hidden" name="cmd" value="_xclick">
                    <input type="hidden" name="currency_code" value="<?php echo BUCKYSROOM_PAYPAL_CURRENCY;?>">
                    
                    
                    <!-- should be set by javascript -->
                    <input type="hidden" name="item_name" value="">
                    <input type="hidden" name="amount" value="">
                    <input type="hidden" name="custom" value="<?php echo $BUCKYS_GLOBALS['payerID'];?>"/>
                    
                    <!-- return url setting -->
                    <input type="hidden" name="notify_url" value="<?php echo BUCKYSROOM_PAYPAL_NOTIFY_URL;?>" > 
                    <input type="hidden" name="return" value="<?php echo BUCKYSROOM_PAYPAL_RETURN_URL;?>">
                    <input type="hidden" name="cancel_return" value="<?php echo BUCKYSROOM_PAYPAL_CANCEL_RETURN_URL;?>">                        
                        ...
                        <div class="tr">
                            <div class="td td-type">
                                <?php
                                    if($row['payerID'] == 0 && $row['activityType'] == BuckysTransaction::ACTIVITY_TYPE_DEPOSIT_BY_PAYPAL)
                                        echo 'Deposit';
                                    else if($row['payerID'] == $BUCKYS_GLOBALS['user']['userID'])
                                        echo 'Payment To';
                                    else if($row['receiverID'] == $BUCKYS_GLOBALS['user']['userID'])
                                        echo 'Payment From';
                                    else
                                        echo 'Paycheck';
                                ?>
                            ...
                            <div class="td td-name">
                                <?php 
                                    ...
                                    if ($row['activityType'] == BuckysTransaction::ACTIVITY_TYPE_TRADE_ITEM_ADD) {
                                        echo '<span>List an item on trade</span>';
                                    }
                            ...
                            <div class="td td-amount">
                                <?php
                                    ...
                                    echo '&#946; ' . number_format($row['amount'], 2);
									echo '</span>';
                                ?>
                            </div>
                            <div class="td td-balance">
                                <?php 
                                    if($row['payerID'] == 0 || $row['receiverID'] == $BUCKYS_GLOBALS['user']['userID'])
                                        echo '+ &#946; ' .number_format($row['receiverBalance'], 2); 
                                    else
                                        echo '+ &#946; ' .number_format($row['payerBalance'], 2); 
                                ?>
                            </div>
