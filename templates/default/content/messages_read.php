        ...
        <section id="right_side_padding" class="user-info-section">
            ...
            <form method="post" id="messagedetailform" action="/messages_read.php" class="user-info">
                ...
                <div class="message-detail">
                    <div class="row">
                        <label>To: </label>
                        <a href="/profile.php?user=<?php echo $message['receiver']?>"><?php echo $message['receiverName']?></a>
                        <div class="clear"></div>
                    </div>
                    <div class="row">
                        <label>From: </label>
                        <a href="/profile.php?user=<?php echo $message['sender']?>"><?php echo $message['senderName']?></a>
                        <div class="clear"></div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                        ...
                        <a href="/report_object.php" data-type="message" data-id="<?php echo $message['messageID']?>" data-idHash="<?php echo buckys_encrypt_id($message['messageID'])?>" class="report-link">Report</a>
                        <?php } ?>
                        <div class="clear"></div>
                    </div>
                ...
                <div class="btn-row">
                    ...
                    <input type="button" class="redButton" value="Reply" id="reply-message" data-id="<?php echo $message['messageID']?>" />
                    <?php } ?>
                </div>
                <input type="hidden" name="action" id="action" value="" />
                <input type="hidden" name="userID" value="<?php echo $userID?>" />
                <input type="hidden" name="senderID" value="<?php echo $message['sender']?>" />
