...
<section id="main_section">    
    ...
    <section id="right_side">
        <section id="right_side_padding" class="user-info-section">
            ...
            <form method="post" id="messagelistform" action="/messages_sent.php" class="user-info" style="padding-top:0px;">
                ...
                <div class="table">
                    ...
                    <div class="tr <?php echo $i == count($messages) - 1 ? 'noborder' : ''?>">
                        ...
                        <div class="td td-from"><a href="/profile.php?user=<?php echo $row['receiver']?>"><?php echo $row['receiverName']?></a></div>
