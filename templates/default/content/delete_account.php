...
<section id="main_section">    
    ...
    <section id="right_side">
        <section id="right_side_padding" class="user-info-section">
            ...
            <form id="deleteaccountform" method="post" name="deleteaccountform" class="user-info" action="/delete_account.php">                
                ...
                <div class="row">
                    ...
                    <span class="inputholder"><input type="password" id="password" name="password" class="input" value="<?php echo isset($_POST['password']) ? $_POST['password'] : ''?>"/></span>
                    <div class="clear"></div>
                </div>
                
                <div class="row">
                    <label for="password2">Confirm Password:</label>
                    <span class="inputholder"><input type="password" id="password2" name="password2" class="input" value="<?php echo isset($_POST['password2']) ? $_POST['password2'] : ''?>"/></span>
                    <div class="clear"></div>
                </div>
