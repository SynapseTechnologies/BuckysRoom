        ...
        <div class="trade-available-list">
            <?php if (isset($view['items']) && count($view['items']) > 0) :?>
                ...
                ?>
                    ...
                    <div class="node">
                        <div class="n1"><a href="<?php echo $viewLink;?>"><img src="<?php echo $thumbFileUrl;?>" /></a></div>
                        <div class="n2">
                        ...
                        <div class="n5">
                            <div class="actionpart">
                                <?php if ($view['type'] != 'expired') :?>
                                        <a href="javascript:void(0)" onclick="deleteTradeItem(<?php echo $itemData['itemID'];?>);">Delete Item</a>
