                            ...
                            <tr>    
                                    ...
                                    <div class="desc">
                                        <div class="t">
											...
											<?php 
												...
												if (is_numeric($score)) {
													if ($score > 0)
														echo '<div class="feedback-positive"></div>';
													else if ($score < 0)
										...
										<!--
                                        <div class="st"><?php echo $tradeData[$myPrefix . 'ItemSubtitle'];?></div>
                                        <div class="i-num">Item Number: <?php echo $tradeData[$myPrefix . 'ItemID'];?></div>
										-->
                                        
                                        <div id="my_shipping_info_<?php echo $tradeData['tradeID']?>" class="row-shipping-info">
                                            <strong>My Shipping Information:</strong>
                                            <?php 
                                                if ($tradeData[$myPrefix . 'ShCountryID'] > 0) {
                                                    echo sprintf("<div>%s</div>", $tradeData[$myPrefix . 'ShFristName'] . ' ' . $tradeData[$myPrefix . 'ShLastName']);
                                                    ...
                                                    echo sprintf("<div>%s</div>", buckys_trade_get_country_name($tradeData[$myPrefix . 'ShCountryID']));
                                                }
                                                else {
                                                    echo '<p>You have not filled out your shipping information. Please fill out them by click <a href="/trade/shipping_info.php">here</a>.</p>';
                                                }
                                            ?>
											<div style="margin-top:10px;color:#999999;">Tracking Number: <span style="color:#006699;" id="my_tracking_number_<?php echo $tradeData['tradeID']?>"><?php echo $myTrackingNumber != ''? $myTrackingNumber:'None';?></span></div>
                                        </div>
                                    </div>
                                    <div class="clear"></div>
                                </td>
                                <td class="their">
                                    ...
                                    <div class="desc">
										...
										<!--
                                        <div class="st"><?php echo $tradeData[$theirPrefix . 'ItemSubtitle'];?></div>
                                        <div class="i-num">Item Number: <?php echo $tradeData[$theirPrefix . 'ItemID'];?></div>
										-->
                                        
                                        
                                        <div id="their_shipping_info_<?php echo $tradeData['tradeID']?>" class="row-shipping-info">
											<div class="clear"></div>
                                            <strong>Their Shipping Information:</strong>
                                            <?php 
                                                if ($tradeData[$theirPrefix . 'ShCountryID'] > 0) {
                                                    echo sprintf("<div>%s</div>", $tradeData[$theirPrefix . 'ShFristName'] . ' ' . $tradeData[$theirPrefix . 'ShLastName']);
                                                    ...
                                                    echo sprintf("<div>%s</div>", buckys_trade_get_country_name($tradeData[$theirPrefix . 'ShCountryID']));
                                                }
                                                else {
                                                    echo '<p>User has not filled out their shipping information. Please message user for address.</p>';
                                                }
                                            ?>
											<div style="margin-top:10px;color:#999999;">Tracking Number: <span style="color:#006699;" id="my_tracking_number_<?php echo $tradeData['tradeID']?>"><?php echo $theirTrackingNumber != ''? $theirTrackingNumber:'None';?></span></div>
                                        </div>
                                ...
                                <td class="act">
                                    <div class="action-group">
                                        ...
                                        <?php if (empty($tradeData[$theirPrefix . 'FeedbackScore']) || $tradeData[$theirPrefix . 'FeedbackScore'] == 0) :?>
                                            <div><a href="javascript:void(0)" class="leave_feedback_btn">Leave Feedback</a></div>
                                        <?php endif;?>
                                        <div><a href="javascript:void(0)" class="leave_tracking_number_btn"><?php if ($tradeData[$myPrefix . 'TrackingNo'] != '') echo "Edit"; else echo 'Leave';?> Tracking Number</a></div>
                                        <div><a href="<?php echo $sendMessageLink;?>">Send Message</a></div>
                                        <div><a href="javascript:void(0)" class="view_shipping_info_btn">View Shipping Info</a></div>
										<div style="margin-top:10px;">Trade ID: <span style="color:#333333;"><?php echo $tradeData['tradeID'];?></span></div>
										<div>Trade Date: <span style="color:#333333;"><?php echo $dateCreated;?></span></div>
                                    </div>
                                </td>
                            </tr>
                        </table>
