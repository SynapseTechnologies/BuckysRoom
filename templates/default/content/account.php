...
<section id="main_section">    
    ...
    <section id="right_side">
        ...
        <section id="activity_feed">
            <h2 class="titles" style="padding-bottom:2px;">My Notifications</h2>
            ...
            <div class="clear"></div>
            <br />
            <h2 class="titles" style="padding-bottom:2px;">Friend Activity</h2>     
        ...
        <section id="stream">
            ...
            <?php render_result_messages(); ?>
                <div style="border-bottom:1px solid #cccccc; margin-top:5px; margin-bottom:10px; float:left;">
                    <a href="/profile.php?user=<?php echo $userID?>"><img src="<?php echo BuckysUser::getProfileIcon($userID)?>" class="postIcons" /></a>
                        ...
                        <form method="post" id="newpostform" action="/manage_post.php">    
                            ...
                            <div class='privacy-row'>                                 
                                <span class="publicPrivatePost">
                                    ...
                                    <label for="post_visibility_private"><input type="radio" name="post_visibility" id="post_visibility_private" value="0" /> Private</label>
                                    <label for="post_visibility_profile" style="display: none;"><input type="radio" name="post_visibility" id="post_visibility_profile" value="2" /> Use as Profile Photo</label>
                                </span>                                
                ...
                <!-- View More Stream -->
                <div class="clear"></div>
                <div id="more-stream" data-page="account"><img src="<?php echo DIR_WS_IMAGE?>loading1.gif" height="15" /></div>
        </section>
    </section>
</section>
