        ...
        <section id="right_side_padding" class="user-info-section">
            ...
            <form id="basicform" method="post" name="infoForm" class="user-info" onsubmit="return false">                
                    ...
                    <div class="row">
                        ...
                        <span class="inputholder"><input type="text" id="firstName" name="firstName" class="input" value="<?php echo $userData['firstName']; ?>"/></span>
                        <div class="clear"></div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <span class="inputholder"><input type="text" id="lastName" name="lastName" class="input" value="<?php echo $userData['lastName']; ?>"/></span>
                        <div class="clear"></div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <span class="inputholder"><input type="text" id="religion" name="religion" class="input" value="<?php echo $userData['religion']; ?>"/></span>
                    ...
                    <div class="row">
                        ...
                        <span class="inputholder"><input type="text" id="political_views" name="political_views" class="input" value="<?php echo $userData['political_views']; ?>"/></span>
                    ...
                    <div class="row">
                        ...
                        <span class="inputholder"><input type="text" id="birthplace" name="birthplace" class="input" value="<?php echo $userData['birthplace']; ?>"/></span>
                    ...
                    <div class="row">
                        ...
                        <span class="inputholder"><input type="text" id="current_city" name="current_city" class="input" value="<?php echo $userData['current_city']; ?>"/></span>
