...
<section id="main_section">    
    ...
    <section id="right_side">
        <section id="right_side_padding" class="user-info-section">
            ...
            <form method="post" id="messagelistform" action="/messages_trash.php" class="user-info" style="padding-top:0px;">
                ...
                <div class="table" id="trash-table">
                    <div class="thead">
                    ...
                    <div class="tr <?php echo $i == count($messages) - 1 ? 'noborder' : ''?>">
                        ...
                        <div class="td td-from"><a href="/profile.php?user=<?php echo $row['sender']?>"><?php echo $userData['firstName'] . " " . $userData['lastName']?></a></div>
                        <div class="td td-to"><a href="/profile.php?user=<?php echo $row['receiver']?>"><?php echo $row['userName']?></a></div>
                        <?php }else{ ?>
                        <div class="td td-from"><a href="/profile.php?user=<?php echo $row['sender']?>"><?php echo $row['userName']?></a></div>
                        <div class="td td-to"><a href="/profile.php?user=<?php echo $row['receiver']?>"><?php echo $userData['firstName'] . " " . $userData['lastName']?></a></div>
                        <?php } ?>                        
                ...
                <div class="btn-row"><input type="button" class="redButton" value="Delete Forever" id="delete-messages" /></div>
