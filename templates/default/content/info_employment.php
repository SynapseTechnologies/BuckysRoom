                ...
                <form id="employmentform" method="post" class="user-info" onsubmit="return false">                
                    ...
                    <div class="row">
                        ...
                        <span class="inputholder">
                            <input type="text" name="employer[]" maxlength="60" class="input" value="<?php echo $row['employer']; ?>" />
                    ...
                    <?php } ?>
                    <div class="btn-row">           
                        <a href="javascript: void(0)" id="add-new-employment" class="add-new-row" data-label="Employer" data-id="employment" data-new-row="new-employment-row">Add New</a>
