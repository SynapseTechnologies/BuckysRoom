    ...
    <section id="right_side" class="profile-contr page-content-container">
        ...
        <?php if ($view['show_only_post'] == false && $view['show_all_post'] == false) :?>
            <div class="info-box" id="friends-box">
                <h3>Followers <a href="/followers.php?pid=<?php echo $pageData['pageID']?>" class="view-all">(view all)</a></h3>
                <?php 
                        ...
                        <div class="new-post-row">
                            <form method="post" id="newpostform" action="/manage_post.php">    
                                <div id="new-post-nav">
                                    ...
                                    <span>|</span>
                                    <a href="#" class="post-image">Photo</a>
                                    <span>|</span>
                                    <a href="#" class="post-video">Video</a>
                                </div>
                                <textarea name="content" class="newPost" placeholder="Create a new post..."></textarea>                            
                                <div id="new-video-url"><label style="font-weight:bold;font-size:11px;" for="video-url">YouTube URL:</label> <input type="text" name="youtube_url" id="youtube_url" class="input" value="" /></div>
                                <div class='privacy-row'>                                 
                                    <span class="publicPrivatePost">
                                        <label for="post_visibility_public"><input type="radio" name="post_visibility" id="post_visibility_public" value="1" checked="checked" /> Public</label>
                                        ...
                                        <label for="post_visibility_profile" style="display: none;"><input type="radio" name="post_visibility" id="post_visibility_profile" value="2" /> Use as Page Logo</label>
                                    </span>                                
                                
                                    <input type="submit" id="save-btn" class="redButton" value="Post" style="display:block;"/>
        ...
        <div class="info-box" id="posts-box">
            <?php if ($view['show_all_post']): ?>
                <h3>Posts <a href="/page.php?pid=<?php echo $pageData['pageID']?>" class="view-all">(back to page)</a></h3>
            <?php else: ?>
                <h3>Posts <a href="/page.php?pid=<?php echo $pageData['pageID']?>&postsonly=1" class="view-all">(view all)</a></h3>
            <?php endif;?>
            <?php
            ...
            <?php if ($view['show_only_post'] == false) :?>
                <div id="more-stream" data-page="page-post" data-page-id="<?php echo $pageData['pageID']?>"><img src="<?php echo DIR_WS_IMAGE?>loading1.gif" height="15" /></div>
            <?php endif;?>
