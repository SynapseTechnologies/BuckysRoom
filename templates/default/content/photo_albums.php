        ...
        <section id="right_side_padding" class="user-info-section">
            ...
            <form method="post" id="newalbumform" action="/photo_albums.php" class="user-info">
                ...
                <div class="new-album-title-row">
                    <input type="text" id="new_album_name" name="new_album_name" class="input" placeholder="Album title..."/> 
                    <input type="submit" id="create_new_album_submit" name="create_new_album_submit" class="redButton" value="Create New Album"/> 
                    <span style="display: none;">
                        Privacy: 
                        <input type="radio" name="visibility" id="visibility_public" value="1" autocomplete="off" checked="checked" /> <label for="visibility_public">Public</label>
                        <input type="radio" name="visibility" id="visibility_private" value="0" autocomplete="off" /> <label for="visibility_private">Private</label>
                    </span>
                </div>
                <div id="all-photos">
            ...
            <div class="table" id="album-list">
                ...
                <div class="tr <?php echo $idx++ == count($albums) ? 'noborder' : ''?>">
                    ...
                    <div class="td td-created-date"><?php echo date('F j, Y', strtotime($row['created_date']))?></div>
                    <div class="td td-action">
                       <a href="/photo_album_edit.php?albumID=<?php echo $row['albumID']?>">Edit</a> | <a href="#" data-id="<?php echo $row['albumID'] ?>" class="delete-album-link">Delete</a>
                    </div>
                    <div class="clear"></div>
                </div>
                <?php
