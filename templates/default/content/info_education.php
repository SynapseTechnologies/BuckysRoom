                ...
                <form id="educationform" method="post" class="user-info" onsubmit="return false">                
                    ...
                    <div class="row">
                        ...
                        <span class="inputholder">
                            <input type="text" name="user_education[]" maxlength="60" class="input" value="<?php echo $row['school']; ?>" />
                    ...
                    <?php } ?>
                    <div class="btn-row">           
                        <a href="javascript: void(0)" id="add-new-education" class="add-new-row" data-label="School Name" data-id="user_education" data-new-row="new-education-row">Add New</a>
