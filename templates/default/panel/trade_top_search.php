...
<section id="trade_top_search">
    <div class="trade-top-search-box">
        <form action="/trade/search.php" method="get" id="trade_search_form">
            <input type="text" name="q" id="trade_s_q" class="q" value="<?php if (isset($view['param']['q'])) echo $view['param']['q'];?>">
            ...
            <input type="hidden" name="loc" id="trade_s_loc" value="<?php if (isset($view['param']['loc'])) echo $view['param']['loc'];?>">
            <input type="hidden" name="sort" id="trade_s_sort" value="<?php if (isset($view['param']['sort'])) echo $view['param']['sort'];?>">
            <input type="hidden" name="user" id="trade_s_user" value="<?php if (isset($view['param']['user'])) echo $view['param']['user'];?>">
