...
<script type="text/javascript">
    var pageLinkList = <?php if ($pageData['links'] != '') {echo json_encode(unserialize($pageData['links']));} else echo json_encode(array());?>;    
</script>
...
<aside id="main_aside" style="overflow:auto"> <!-- 241px -->
    ...
    <div class="info-box">
        <h3 id="page_title_display"><span><?php echo $pageData['title']; ?></span> <?php if($view['isMyPage']) :?><a href="javascript:void(0)" class="edit-info" id="edit_page_title_btn">(edit)</a><?php endif;?></h3>
        <div class="page-title-edit-panel">
            <input type="text" id="page_title_input" value="<?php echo $pageData['title']; ?>" maxlength="200">
            <input type="button" value="Save" id="save_page_title" class="redButton">
        </div>
    </div>
    ...
    <?php else :?>
        <?php 
            if ($view['isFollowed']) {
                echo sprintf('<a href="/page.php?pid=%d&action=unfollow">Unfollow</a> <br/>', $pageData['pageID']);
            }
            else {
                echo sprintf('<a href="/page.php?pid=%d&action=follow">Follow</a> <br/>', $pageData['pageID']);
            }
        ?>
    <?php endif;?>
    ...
    <div class="page-about-sidebox info-box">
        ...
        <div class="page-about-content">
            ...
            <div class="about-text-edit-panel">
                <textarea id="about_text_input" class="about-textarea" maxlength="5000"><?php echo $pageData['about'];?></textarea>
                <input type="button" value="Save" id="save_about_text" class="redButton">
            </div>
        </div>
    </div>
