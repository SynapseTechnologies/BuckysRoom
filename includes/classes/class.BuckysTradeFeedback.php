...
class BuckysTradeFeedback
{
    ...
    public function addFeedback($tradeID, $userID, $score, $feedback)
    {
        ...
        if ($tradeData['sellerID'] == $userID) {
            $param = array(
                ...
                'sellerToBuyerScore' => $score,
                'sellerToBuyerFeedback' => $feedback,
                'sellerToBuyerFeedbackCreatedAt' => date('Y-m-d H:i:s')
            );
            ...
            $param = array(
                ...
                'sellerID' => $tradeData['sellerID'],
                'buyerID' => $tradeData['buyerID'],
                'buyerToSellerScore' => $score,
                'buyerToSellerFeedback' => $feedback,
                'buyerToSellerFeedbackCreatedAt' => date('Y-m-d H:i:s')
            );
    ...
    */
    public function updateFeedback($feedbackID, $userID, $score, $feedback) {
        ...
        $res = $db->updateFromArray( TABLE_TRADE_FEEDBACK, $param, array('feedbackID' => $feedbackID) );
    ...
    */
    public function _updateRanking($userID) {
        ...
        $tradeUserIns->updateTradeUser($userID, array('totalRating'=>$totalFeedback, 'positiveRating'=>$positiveFeedback));
    }
