...
if($_POST['page'] == 'account'){
    ...
    if ($pageData) {
        ...
        {
            ?>
            <a href="/page.php?pid=<?php echo $row['pageID']?>&post=<?php echo $row['postID']?>" class="photo"><img src="<?php echo DIR_WS_PHOTO ?>users/<?php echo $row['poster']?>/thumbnail/<?php echo $row['image']?>" data-posted-date='<?php echo $row['post_date']?>' /></a>
            <?php
        }
    }
    ...
    {
        ?>
        <a href="/posts.php?user=<?php echo $row['poster']?>&post=<?php echo $row['postID']?>" class="photo"><img src="<?php echo DIR_WS_PHOTO ?>users/<?php echo $row['poster']?>/thumbnail/<?php echo $row['image']?>" data-posted-date='<?php echo $row['post_date']?>' /></a>
        <?php
    }
}