...
switch($paramType) {
    case 'expired':
        $view['pagetitle'] = 'My Items Expired';
    ...
    default:
        ...
        $view['pagetitle'] = 'My Items Available';
        $view['type'] = 'available';
        break;
}

$view['items'] = buckys_trade_pagination($view['items'], $baseURL, $paramCurrentPage, TRADE_ROWS_PER_PAGE);
