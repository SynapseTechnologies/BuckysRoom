...
$view['offers'] = buckys_trade_pagination($view['offers'], '/trade/offer_made.php', $paramCurrentPage, TRADE_ROWS_PER_PAGE);

$BUCKYS_GLOBALS['title'] = 'Offer Made - BuckysRoomTrade';
