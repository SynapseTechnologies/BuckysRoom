...
(function($, win, doc){
    ...
    var MyEditor = function(element, options){
        ...
        var $controller = $('<span class="editor-controlls">' + 
                            '<a href="#" class="ectrl-bold" title="Bold">B</a>' + 
                            '<a href="#" class="ectrl-italic">I</a>' + 
                            '<a href="#" class="ectrl-underline">U</a>' + 
                            '<a href="#" class="ectrl-link">link</a>' + 
                            '<a href="#" class="ectrl-ordered-list">Ordered list</a>' + 
                            '<a href="#" class="ectrl-unordered-list">Unordered list</a>' +
                            '<a href="#" class="ectrl-img">Image</a>' +
                            '<a href="#" class="ectrl-code">Code</a>' + 
                            '</span>');
        ...
        $controller.find('.ectrl-bold').click(function(){
             ...
             var tmp = caretGetInfo($caret[0]),
                 org = $caret.val(),
                 pos = $caret.scrollTop(),
                 range = {start: tmp.start + 3, end: tmp.end + 3};
