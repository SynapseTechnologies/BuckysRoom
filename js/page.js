    ...
    $(document).ready(function() {
        ...
        $("#save_about_text").click(function() {
            if ($("#about_text_input").val() == '') {
                ...
                $.ajax({
                    url: '/page.php',
                    data: {action: 'updateAbout', pageID: $("#currentPageID").val(), content: $("#about_text_input").val()},
                    type: 'post',
        ...
        $("#save_page_title").click(function() {
            if ($("#page_title_input").val() == '') {
                ...
                $.ajax({
                    url: '/page.php',
                    data: {action: 'updatePageTitle', pageID: $("#currentPageID").val(), content: $("#page_title_input").val()},
                    type: 'post',
                    success: function(rsp)
                    {
                        var responseObj = $.parseJSON(rsp);
