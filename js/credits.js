(function($){
    ...
    $('#receiver').autocomplete({
        ...
        select: function( event, ui ) {            
            //Add New Item
            $('#receiverholder').append('<span class="name">' + ui.item.label + ' <a href="#">x</a>'  +
                            '<input type="hidden" name="receiverID" value="'  + ui.item.id + '" />' + 
                            '<input type="hidden" name="receiverIDHash" value="'  + ui.item.hash + '" /></span>'
                            );
